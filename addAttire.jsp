<%-- 
    Document   : addAttire
    Created on : Dec 26, 2025, 5:35:56 PM
    Author     : user
--%>
...
<html>
<head>
<title>Add New Attire | Busana Tradisi</title>
        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="header-subtitle">
                    Add new traditional attire details, rental pricing and collection information professionally.
                </div>
            ...
            <form action="AddAttireServlet"
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           name="attireName"
                           placeholder="Example: Baju Kurung Moden"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           name="category"
                           placeholder="Example: Traditional Wear"
                           required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description"
                              rows="4"
                              placeholder="Example: Bust 32-36 inch, Waist 26-30 inch"
                              required></textarea>
