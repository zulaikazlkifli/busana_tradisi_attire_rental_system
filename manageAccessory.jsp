<%-- 
    Document   : manageAccessory
    Created on : Mar 31, 2026, 10:53:15 PM
    Author     : user
--%>
...
<%
    ...
    ArrayList accessoryList =
        (ArrayList) request.getAttribute("accessoryList");
%>

<!DOCTYPE html>
<html>
<head>
<title>Manage Accessories | Busana Tradisi</title>
    ...
    <div class="main">
        ...
        <div class="hero-card">
            ...
            <div class="hero-subtitle">
                Manage accessory collections, pricing, quantity and outfit matching professionally.
            </div>
        ...
        <div class="action-bar">
            ...
            <div class="total-box">
                ...
                <h2>
                    <%= accessoryList != null ? accessoryList.size() : 0 %>
                </h2>
            ...
            <a href="GoAddAccessoryServlet" class="add-btn">
            ...
            <table>
                ...
                if(accessoryList != null && accessoryList.size() > 0){
                    ...
                    for(int i=0;i<accessoryList.size();i++){
                        ...
                        ArrayList row =
                            (ArrayList) accessoryList.get(i);
                %>

                <tr>

                    <td>
                    ACC<%= String.format("%03d", i + 1) %>
                    </td>
                    ...
                    <td>
                        ...
                        src="<%=request.getContextPath()%>/uploads/<%=row.get(3)%>">
                    ...
                    <td>
                        ...
                        <div class="action-container">
                            ...
                            <a href="EditAccessoryServlet?id=<%=row.get(0)%>"
                            class="btn btn-edit">
                                Edit
                            </a>

                            <a href="DeleteAccessoryServlet?id=<%=row.get(0)%>"
