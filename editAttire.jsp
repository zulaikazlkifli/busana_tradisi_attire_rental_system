<%-- 
    Document   : editAttire
    Created on : Jan 7, 2026, 12:46:19 PM
    Author     : user
--%>
...
<html>
<head>
<title>Edit Attire | Busana Tradisi</title>
        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="header-subtitle">
                    Update attire information, rental pricing and outfit availability professionally.
                </div>
            ...
            <form action="EditAttireServlet" method="post">

                <!-- HIDDEN ID -->

                <input type="hidden"
                       name="attireID"
                       value="<%= request.getAttribute("attireID") %>">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           name="attireName"
                           value="<%= request.getAttribute("attireName") %>"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                           step="0.01"
                           name="rentalPrice"
                           value="<%= request.getAttribute("rentalPrice") %>"
                           required>
                ...
                <div class="form-group">
                    ...
                    <select name="status">
                        ...
                        <%= "AVAILABLE".equals(request.getAttribute("status")) ? "selected" : "" %>>
                            AVAILABLE
                        </option>

                        <option value="UNAVAILABLE"
                        <%= "UNAVAILABLE".equals(request.getAttribute("status")) ? "selected" : "" %>>
                            UNAVAILABLE
                        </option>
